...
public class HeapsEstaticoMin implements HeapsTDA{
    ...
    private void flotar(int i) {
        while (i > 0 && heap[padre(i)] > heap[i]) {  //en caso de que el heap padre sea mayor que el heap hijo.
            swap(padre(i), i); //los cambia en el metodo de arriba.
            i = padre(i); //busca la indice del padre en el metodo de arriba.
        }
    }

    public void InicializarHeap() {//inicializa el heap, con cantidad 0 de elementos.
    ...
    public int primero() {
        return heap[0];  //devuelve el primer elemento del heap, en este caso el menor.
    }
